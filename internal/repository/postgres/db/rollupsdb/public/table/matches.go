...
func newMatchesTableImpl(schemaName, tableName, alias string) matchesTable {
	var (
		...
		allColumns              = postgres.ColumnList{ApplicationIDColumn, EpochIndexColumn, TournamentAddressColumn, IDHashColumn, CommitmentOneColumn, CommitmentTwoColumn, LeftOfTwoColumn, WinnerCommitmentColumn, BlockNumberColumn, TxHashColumn, CreatedAtColumn, UpdatedAtColumn}
		mutableColumns          = postgres.ColumnList{CommitmentOneColumn, CommitmentTwoColumn, LeftOfTwoColumn, WinnerCommitmentColumn, BlockNumberColumn, TxHashColumn, CreatedAtColumn, UpdatedAtColumn}
	)
